...
public final class DriveConstants {
  ...
  public static final class ModuleConstants {
    ...
    public static final double ENCODER_OFFSET_FL = Units.rotationsToRadians(0.091553 + 0.5); //Teste com 180 graus de volta (+ 0.5 rotações)

    // Front Right
    public static final int TALON_FR = 4;
    public static final int SPARK_FR = 5;
    public static final int CANCODER_FR = 6;
    public static final double ENCODER_OFFSET_FR = Units.rotationsToRadians(0.324707 + 0.5);

    // Back Left
    public static final int TALON_BL = 7;
    public static final int SPARK_BL = 8;
    public static final int CANCODER_BL = 9;
    public static final double ENCODER_OFFSET_BL = Units.rotationsToRadians(-0.112549 + 0.5);

    // Back Right
    public static final int TALON_BR = 10;
    public static final int SPARK_BR = 11;
    public static final int CANCODER_BR = 12;
    public static final double ENCODER_OFFSET_BR = Units.rotationsToRadians(0.373047 + 0.5);
