...
public class Drive extends SubsystemBase {
  private static final double MAX_LINEAR_SPEED = Units.feetToMeters(1); // estava em 14.5
  ...
  private Translation2d inicial2dEstimator = new Translation2d(0.49268914393331, 1.528351225503814);
  private SwerveDrivePoseEstimator poseEstimator =
      new SwerveDrivePoseEstimator(
          kinematics,
          rawGyroRotation,
          lastModulePositions,
          new Pose2d(inicial2dEstimator, new Rotation2d()));
  ...
  /** Resets the current odometry pose to zero position in the field. */
