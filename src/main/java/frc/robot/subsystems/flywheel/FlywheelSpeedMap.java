...
public class FlywheelSpeedMap {
    ...
    private PolynomialSplineFunction createSpeedCurve() {
        ...
        double[] speedValues = {800.0, 1000.0, 2000.0, 2500.0, 3000.0}; // Velocidades correspondentes em RPM 
        ...
        for (int i = 0; i < polynomials.length; i++) {
            ...
            double b = (speedValues[i + 1] - speedValues[i]) / (distanceValues[i + 1] - distanceValues[i]);
