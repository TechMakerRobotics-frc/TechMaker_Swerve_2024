...
public class LimelightHelper {
  ...
  public static Translation2d getAprilTagCoordinates(
      int tagNumber) { // coordinates of all april tags
  ...
  public static int getClosestColumn(
      Translation2d pose, boolean isCube) { // this only works for blue for now i think????
    double y = pose.getY();
    int closestColumn = 0;
  ...
  public static Translation2d getColumnCoordinates(
      int column) { // gets coordinates of a certain column
  ...
  public static Translation2d getCurrentAprilTagCoordinates(
      String limelightName) { // gets the april tag the limelight is currently seeing
    return getAprilTagCoordinates(
        (int)
            getFiducialID(limelightName)); // this isn't the closest, it's just the one we're seeing
  }
}
